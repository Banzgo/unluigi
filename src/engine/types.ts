...
export interface SimulationParameters {
	...
	specialSaveType?: SpecialSaveType; // Type of special save: 'aegis' or 'regeneration'
	...
	lethalStrike?: boolean; // 6s to wound ignore armor and regeneration saves (but not aegis)
...
export interface HitTracker {
	...
	isNaturalSixToWound: boolean; // Unmodified to-wound roll was a 6
}
